import { GetVehicles, GetPilotNamesForVehicles, GetFilmsByTitle } from "../services/apiCalls.js";
...
const CreateVehicleElements = async () => {
    ...
    mainRow.className = 'row mb-5';
    const firstCol = document.createElement('div');
    firstCol.className = 'col-12 d-flex justify-content-between mb-5';
    const prevButton = document.createElement('div');
    prevButton.className = 'btn btn-danger text-dark fw-bolder mx-5';
    ...
    vehicleData.results.map(vehicle => {
        ...
        mainColCard.className = 'col-8 border border-light bg-dark text-light p-4 rounded-4 mb-5';
        ...
        firstInnerColSix.className = 'col-6';
        ...
        secondInnerColSix.className = 'col-6 d-flex flex-column align-items-start';
        ...
        thirdInnerColSix.className = 'col-6';
        ...
        fourthInnerColSix.className = 'col-6';
